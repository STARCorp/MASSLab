classdef (Abstract) SEPPlugin < MASSPlugin
...
%     Ph.D. Dissertation, University of Massachusetts Dartmouth, Jan. 2019.
    ...
    properties (Hidden)
        ...
        semCDS; % Common demixing solution produced by SEM
        semSrcNum;
        semCDSFiltLen;
        semCDSFiltOffset;
    end
    ...
    properties (GetAccess = public, SetAccess = protected)
        ...
        se = SourceEstimate(); % Source estimates produced by the plugin
        cds = [];
        % Signal Requirements
        reqSrcNum = 0;
        reqSrcSig = 0;
...
%         coop;
    ...
    methods
        function obj=SEPPlugin()
            obj.superClassHidden = 'SEPPlugin';
            obj.pluginStatus = 0;
        end
...
%         function out = getBlkLenMin(obj), out = obj.blkLenMin; end
%         function out = getBlkLenMax(obj), out = obj.blkLenMax; end
%         function out = getSrcEst(obj), out = obj.sepSrcEst; end
%         function out = getCds(obj), out = obj.sepCds; end
    end
    
%     methods (Hidden)
%         function setSemObs(obj,OBS), obj.semObs = OBS; end
%         function setSemSrc(obj,SRC), obj.semSrc = SRC; end
%         function setSemCds(obj,CDS), obj.semCds = CDS; end
%         
%     end

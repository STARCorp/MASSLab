classdef (Abstract) Configuration < handle
...
%     Ph.D. Dissertation, University of Massachusetts Dartmouth, Jan. 2019.
    ...
    properties (GetAccess = public, SetAccess = protected)
        ...
        % DAPlugin data Sources
        daObsExtSig; % ExternalSignal []
        daSrcExtSig; % ExternalSignal []
        
        % DOPlugin data destination
        doDestExtSig; % ExternalSignal
        
        % PluginInst Plugin definitions
    ...
    methods
        function obj = Configuration()
            % Configuration()
            obj.superClassHidden  = 'Configuration';
        end
    end

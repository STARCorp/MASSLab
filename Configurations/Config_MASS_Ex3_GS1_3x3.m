classdef Config_MASS_Ex3_GS1_3x3 < Configuration
% MASS Example using Blind SEP methods with Supervised SEE:
% -- SEP: SEP_MCLP, SEP_TTSE SEP plugins
...
%     Ph.D. Dissertation, University of Massachusetts Dartmouth, Jan. 2019.
    ...
    methods
        % **************************************************************
        % Constructor
        function obj = Config_MASS_Ex3_GS1_3x3()
            
            % **********************************************************
            % Configuration Properties
            obj.configName = 'MASS Example 3';
            obj.configDescr = 'MASS Example 3: Semi-Blind MASS';

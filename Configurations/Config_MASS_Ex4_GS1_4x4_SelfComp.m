classdef Config_MASS_Ex4_GS1_4x4_SelfComp < Config_MASS_Ex4_GS1_4x4
...
%     Ph.D. Dissertation, University of Massachusetts Dartmouth, Jan. 2019.
    ...
    methods
        % **************************************************************
        % Constructor
        function obj = Config_MASS_Ex4_GS1_4x4_SelfComp()
            
            % **********************************************************
            % Configuration Properties
            obj.configName = 'MASS Example 2';
            obj.configDescr = 'MASS Example 2: Blind MASS with Self-Competition';
